...
export const Checkout = ({setCheckout, total, cartList,clearCart}) => {
    ...
    useEffect(() => {
        function randomGen(){
            const combinationLimit = 15;
            let generatedNumbers = [];
            for( let combi = 1; combi <= combinationLimit; combi++ ){
                let randomNumber = Math.floor(Math.random() * 9);
                generatedNumbers += randomNumber
            }   
            setCardCode(generatedNumbers)
        }
        randomGen()
    }, [])
    ...
    useEffect(() => {
        // To fetch the users specifically
    ...
    async function handleOrders(event){
        // prevent from clicking the link
                ...
                <div className="py-6 px-6 lg:px-8">
                    ...
                    <form onSubmit={handleOrders} className="space-y-6" >
                        ...
                        <div>
                            ...
                            <input type="number" name="card" id="card" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value="027027027" disabled required="" />
                        </div>
                        <div className="">
                        ...
                        <div>
                            ...
                            <input type="number" name="code" id="code" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value={cardCode} disabled required="" />
                        </div>
